...
```{r speaker.type model twin, message=FALSE, warning=FALSE}
...
```{r Sibling input twin, message=FALSE, warning=FALSE}
...
```{r Sibling input discrete sibs, message=FALSE, warning=FALSE}
