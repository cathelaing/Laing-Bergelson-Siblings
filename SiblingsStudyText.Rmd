...
<!-- eb2cl: not clear what the range is the referring to in the first sentence, can you clarify? i think it's the # of sibs, right? also can we convert siblings age to years instead of days in sentence 2? -->
...
<!-- cl2eb: the missing video is at 6m so this actually doesn't matter to the analysis since we don't analayse data before 10months//eb2cl:great! actually you're right that we needn't even mention this then bc it'll oly confuse ppl, editing it out. -->
...
<!-- cl2eb: 2 infants have outliers for both input and obj presence - argh! for one it's just one session, the other is 4 recordings.I've addded a note about this below; none of the outputs change with this infant removed so can add this to the SI maybe. Though tbh that feels a bit OTT to me but will do so and then we can remove it if we decide it's not useful.//eb2cl might as well keep it in supplementals for now though i agree it's a little extra;) -->
...
<!-- eb2cl: just a note to double check that what we say about S4 is true once we fix the analyses there -->
