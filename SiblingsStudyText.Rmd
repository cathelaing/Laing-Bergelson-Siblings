...
We analyzed number of siblings based on parental report in the demographics questionnaires completed at 0;6 (R: `r sibnums$minsibs`-`r sibnums$maxsibs`). Siblings were on average `r age.diff.inyears` years older than the infants in this study (Mdn days: `r sibage$mediandays`, SD: `r round(sibage$sddays,0)`, R: `r minsib`-`r round(maxsib,0)` years).[^2] *All siblings lived in the household with the infant full time, apart from one infant had XX older siblings who lived in the household XX% of the time. One family had a foster child live in the home for XX months of data collection.* All siblings were older than or of the same age as the infant in question.[^3] 
