...
The 'sibling effect' - that is, the apparent advantage for earlier-born versus later-born children - was noted as far back as the 1800s, when Galton [-@galton_english_1874] observed that notable 'English men of science' were often firstborns. Galton [-@galton_english_1874, p.35] posited that these men "would generally have more attention in [their] infancy...than [their] younger brothers and sisters", thereby giving them more of a chance of later success. Current research supports these claims, showing that those who have fewer older siblings are more likely to do better than their laterborn peers in a range of domains, including educational outcomes [@monfardini_birth_2016; @esposito_importance_2020], overall earnings [@behrman_birth_1986; @kantarevic_birth_2006], and some aspects of physical and mental health [@black_healthy_2016]. That is to say that there may be marked economic, social and physical advantages for children with fewer older siblings. In this paper, we consider the role of the early language environment in this story: Educational attainment is shaped by a child's early language outcomes [@anderson_vocabulary_1981; @marchman_speed_2008]; children who had higher vocabulary scores at age 2 do better on a range of language and literacy measures at 10-11 years of age [@lee_size_2011]. Given that quality and quantity of the early linguistic input is a key predictor of lexical advance [@cartmill_quality_2013; @ferjan_ramirez_parent_2020], it may be the case that having more siblings in the early learning environment has a negative effect on language development. With this in mind, we use naturalistic home-recorded data to observe input differences between earlier- and later-born infants in relation to their lexical development over the first 18 months of life. 
...
2)	**More 'learnable' words** [words that tend to be acquired earlier; @fenson_variability_1994] will occur in the input of infants with fewer siblings, and this will decrease as sibling number increases. Input from older children will generate a wider variety of lexical items in the input, including words directed to and produced by siblings, some of whom will still be young language learners themselves. As a result, when siblings are present, fewer input words will be oriented specifically towards the infant. 
...
Data was taken from the SEEDLingS corpus [@bergelson_day_2019], a longitudinal set of data incorporating at-home recordings, parental reports and experimental studies from the ages of 0;6 to 1;6. The present study draws on the parental report data, and annotations of hour-long home video recordings, taken on a monthly basis during data collection.
...
Three input measures were considered in our analysis, pertaining to aspects of the input that are established as being important in early language learning: **overall parental input** (how much speech does an infant hear?), **early-acquired words** (how much of that speech features typically early-learned nouns?), and **object presence** (how much of that speech is referentially transparent?).
...
*Early-acquired words* shows how many of the object words in the parental input (or their lemmas in the case of plurals and diminutives) appeared on the “Words & Gestures” communicative development inventory [CDI, @fenson_variability_1994]. This CDI form offers an inventory of words typically acquired by infants from the United States between the ages of 8 and 18 months [@fenson_macarthur-bates_2007]. Acquisition norms were established from a sample of over 1,700 infants from diverse backgrounds (~50% firstborn, 73% White, 44% of mothers with a college diploma), and so the CDI is taken as a standardized proxy of words typically acquired by infants in early development. Words found on the CDI are, by definition, more learnable in early acquisition, though the reasons underlying their learnability likely differ. Thus, CDI words like *foot* and *banana* are acquired earlier than non-CDI words like *jet ski* or *wheel*, though many factors (e.g. frequency, concreteness, phonology) contribute to this. 
...
[^3]: 1 was added to the raw infant production data before log-transformation to account for datapoints with zero words.
