...
sibsYN.types_anova_video <- anova(sibsYN.model.types_video, sibsYN.model.types_video.null) # NS
...
sibnumber.types_anova_video <- anova(sibnumber.model.types_video, sibnumber.model.types_video.null) # p<.05
...
speaker.type.model <- lmerTest::lmer(Log.n ~ SibGroup + Speaker + (1|subj), data=subset(speaker.type, audio_video == "video"), REML=FALSE)
