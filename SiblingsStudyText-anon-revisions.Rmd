...
# sibsYN_CI <- as.data.frame(confint(sibsYN.model)) %>%
#   rownames_to_column() %>% filter(rowname == "SibsYNY")
# sibsYN_lower <- sibsYN_CI$`2.5 %`
# sibsYN_upper <- sibsYN_CI$`97.5 %`
...
# sibgroup_CI <- as.data.frame(confint(sibgroup.model)) %>%
#   rownames_to_column() %>% filter(rowname == "SibsYNY")
# sibgroup_lower <- sibgroup_CI$`2.5 %`
# sibgroup_upper <- sibgroup_CI$`97.5 %`
...
object.presence_r2 <- r2.corr.mer(object.presence.anova) 
